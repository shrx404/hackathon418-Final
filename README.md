...
- **Quantization:** Running at AMP. INT8 quantization could reduce the 1.9 GB RAM footprint further. Potentially improving the satellite power budget. But remains untested.
